...
class DPGBuildCommand(distutils.cmd.Command):
  ...
  def run(self):
    ...
    if get_platform() == "Windows":
        ...
        #     r'"C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin";'
        #     r'"C:\Program Files (x86)\Microsoft Visual Studio\2019\Professional\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin";'
        #     r'%PATH% && ']
        command = [
            r'set PATH='
